  ...
  return (
    <>
      ...
      >
        ...
        <Button mr={{ base: "0", md: "4" }} onClick={createCategoryHandler}>
          Add Category
        </Button>
      </Box>

      <Box p={4}>
        <HStack width="100%" alignItems="flex-start" pb="4">
          <Box width={"100%"}>
            <Box display={"flex"} pb={"4"} pl="2">
              <Text width={["20%", "10%"]}>SN</Text>
              <Text width={["60%", "60%"]}>Name</Text>
              <HStack spacing={16} width={["20%", "20%"]} alignItems={"center"}>
                <Text>Actions</Text>
              </HStack>
            </Box>
